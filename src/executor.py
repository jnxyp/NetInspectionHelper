...
from sites import SITES, ALL_SITE_NAMES
from util import p


class Executor:
    def __init__(self, companies: list, included_sites: list = ALL_SITE_NAMES):
        ...
        for company_name in self.get_companies():
            ...
            for site_name in self.get_sites():
                ...
                if attempt > MAX_RETRY:
                    self.failed_sites[company_name].append(site_name)
                    p("\t放弃抓取页面")
